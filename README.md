...
```sh
 git clone https://github.com/ohyajk/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/ohyajk/hello-rails-react/issues).
...
This project is [MIT](https://github.com/ohyajk/hello-rails-react/blob/app/MIT.md) licensed.
